<template>
    <div>
      ...
      <button @click="saveQuestion" :disabled="!isValidQuestion">Save</button>
      <button @click="deleteQuestion()" :disabled="!isValidQuestion">Delete</button>
    </div>
  </template>
...
const deleteQuestion = async () => {
  await managedApi.restQuizQuestionController
    .deleteQuestion(quizQuestionAndAnswer.value.id)
  emit("close-dialog", {})
}
</script>
